...
public class SharePrice {
    ...
    @XmlElement(name = "Currency", namespace = "tradeList", required = true)
    protected String currency;
    @XmlElement(name = "Value", namespace = "tradeList")
    protected double value;
    @XmlElement(name = "OpenValue", namespace = "tradeList")
    protected double openValue;
    @XmlElement(name = "CloseValue", namespace = "tradeList")
    protected double closeValue;
    @XmlElement(name = "HighValue", namespace = "tradeList")
    protected double highValue;
    @XmlElement(name = "LowValue", namespace = "tradeList")
    protected double lowValue;
    @XmlElement(namespace = "tradeList", required = true)
